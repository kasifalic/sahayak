...
const TEACHER_FOCUSED_ANSWERS = [
  ...
  "Respected Teacher, I can help you create lesson plans, explain concepts, or answer any teaching-related questions.",
  "Respected Teacher, would you like help with classroom management strategies or student engagement techniques?",
  "Respected Teacher, I can assist you with curriculum planning, assessment methods, or teaching methodologies."
];
...
function getTeacherFocusedAnswer() {
  return TEACHER_FOCUSED_ANSWERS[Math.floor(Math.random() * TEACHER_FOCUSED_ANSWERS.length)];
}
      ...
      {open && (
        <div className="fixed bottom-6 right-6 z-50 w-80 max-w-full bg-white rounded-2xl shadow-2xl flex flex-col border border-gray-200 animate-fade-in">
          ...
          <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 bg-blue-600 rounded-t-2xl">
            <span className="text-white font-semibold text-lg">Teaching Assistant</span>
